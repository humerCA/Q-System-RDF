...
const Sidebar = () => {
  return (
    <>
      <div className="flex h-screen w-[250px] flex-1 flex-col justify-between bg-[#25282D] py-5 text-white shadow-lg">
        <div className="flex w-full flex-col space-y-8">
          <div className=" px-8 pt-2">
            <img src={MainLogo} alt="Q-System" className="w-56 items-center" />
          </div>
          <SidebarMenus />
        </div>
